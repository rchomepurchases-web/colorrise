  ...
  return (
    <main className="service-page">
      ...
      <section className="service-hero">
        <div className="service-hero-copy"><p className="eyebrow light">Where we work</p><h1>Painting Services Across<br /><em>the Phoenix Metro.</em></h1><p>Color Rise Coatings provides residential and commercial painting throughout the Valley, with a focus on documented scope, Arizona-aware preparation, professional coatings, clear communication, and dependable project management.</p><div className="hero-actions"><a className="button spectrum" href="#service-estimate">Get a free estimate <span>↗</span></a></div></div>
      ...
      <section className="service-process section"><p className="eyebrow light">Additional Phoenix metro coverage</p><h2>Serving homeowners<br /><em>throughout the Valley.</em></h2><ol>{["Paradise Valley", "Ahwatukee", "Peoria", "Glendale", "Goodyear", "Avondale"].map((city, index) => <li key={city}><span>{String(index + 1).padStart(2, "0")}</span><div><h3>{city}</h3><p>These communities are within our broader target coverage. Contact Color Rise with the property address to confirm current scheduling availability.</p></div></li>)}</ol></section>
