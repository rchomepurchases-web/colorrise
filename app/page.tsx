...
export default function Home() {
  ...
  return <main>
    ...
    <section className="services section estimate-process"><div className="section-heading"><div><p className="eyebrow">Your estimate</p><h2>Your project. Your options.<br/><em>Your choice.</em></h2></div><p>After we inspect your project, you can receive up to three clearly defined options when multiple approaches make sense.</p></div><div className="service-grid">
      <article className="service-card interior"><span className="service-number">ESSENTIAL</span><div><h3>Essential</h3><p>A quality repaint solution covering the essential preparation, professional coating system, and workmanship needed to complete the selected scope correctly.</p></div></article>
      <article className="service-card exterior"><span className="service-number">SIGNATURE</span><div><h3>Signature <small>— Most Popular</small></h3><p>Enhanced surface preparation, upgraded coating choices, and additional protection or warranty benefits where they materially improve the project.</p></div></article>
      <article className="service-card cabinets"><span className="service-number">PREMIER</span><div><h3>Premier</h3><p>Our highest applicable specification for homeowners prioritizing maximum preparation, premium coating choices, and the strongest available protection.</p></div></article>
