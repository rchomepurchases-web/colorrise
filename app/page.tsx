...
const standard = [
  ...
  ["05", "Final quality walkthrough", "We review the completed work against the written scope with you, address agreed punch-list items, clean up, and close out the project properly."],
];
...
const faqs = [
  ...
  ["What are Essential, Signature & Premier options?", "When appropriate, we present clear proposal options so you can compare scope, preparation, products, warranty, and investment instead of trying to decode competing estimates."],
  ["Do you offer a workmanship warranty?", "Yes. Eligible projects include a 3-year Essential, 5-year Signature, or up to 8-year Premier limited workmanship warranty. The term depends on the selected package and covered surface. Your written proposal and warranty identify the applicable term, eligibility requirements, conditions, and exclusions."],
...
export default function Home() {
  ...
  return <main>
    ...
    <section className="trust-strip"><div><strong>Detailed written scope</strong><span>Know what is included before work begins.</span></div><div><strong>Arizona-aware preparation</strong><span>Prep and products matched to demanding desert conditions.</span></div><div><strong>Company-led quality control</strong><span>A defined scope, project oversight, and final walkthrough guide the work.</span></div><div><strong>Up to an 8-Year Workmanship Warranty</strong><span>Package and covered-surface eligibility apply.</span></div></section>
    ...
    <section className="process section"><div className="process-intro"><p className="eyebrow">The Color Rise Standard</p><h2>A higher standard<br/><em>should be measurable.</em></h2><p>Every Color Rise project follows a company-led process, from a documented scope and preparation standards to project oversight and a final homeowner walkthrough. Clear checkpoints help our crews work to the same standard on every job.</p><img src="/christina-rumpf-XWDMmk-yW7Q-unsplash.jpg" alt="Painter applying a careful finish"/></div><ol>{standard.map(([n,title,text]) => <li key={n}><span>{n}</span><div><h3>{title}</h3><p>{text}</p></div></li>)}</ol></section>
    ...
    <section className="services section estimate-process"><div className="section-heading"><div><p className="eyebrow">Your estimate</p><h2>Your project. Your options.<br/><em>Your choice.</em></h2></div><p>After we inspect your project, you can receive up to three clearly defined options when multiple approaches make sense.</p></div><div className="service-grid">
      <article className="service-card interior"><span className="service-number">ESSENTIAL</span><div><h3>Essential</h3><p>A quality repaint solution covering the essential preparation, professional coating system, and workmanship needed to complete the selected scope correctly. Eligible covered surfaces include a 3-year limited workmanship warranty.</p></div></article>
      <article className="service-card exterior"><span className="service-number">SIGNATURE</span><div><h3>Signature <small>— Most Popular</small></h3><p>Enhanced surface preparation, upgraded coating choices, and additional protection where they materially improve the project. Eligible covered surfaces include a 5-year limited workmanship warranty.</p></div></article>
      <article className="service-card cabinets"><span className="service-number">PREMIER</span><div><h3>Premier</h3><p>Our highest applicable specification for homeowners prioritizing maximum preparation, premium coating choices, and the strongest available protection—up to an 8-year limited workmanship warranty on eligible covered surfaces.</p></div></article>
    ...
    </div><p className="warranty-qualifier">Warranty length depends on the selected package and covered surface. See the written warranty for eligibility, terms, and exclusions.</p><div className="process-estimate-cta"><a className="button navy" href="#estimate">Get my free estimate <span>↗</span></a><small>Financing available — including <strong style={{ color: "var(--gold)", fontWeight: 800 }}>0% APR</strong> for up to 24 months for qualified customers.</small></div></section>
