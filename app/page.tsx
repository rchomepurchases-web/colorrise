    ...
    <main>
      ...
      <section className="hero" id="home">
        <header className="nav-shell">
          ...
          <nav aria-label="Main navigation"><a href="#home">Home</a><a href="#about">About</a><a href="#services">Services</a><a href="/service-areas">Service Areas</a></nav>
          <a className="nav-cta" href="#estimate">Free estimate <span>↗</span></a>
        </header>
        <div className="hero-copy"><p className="eyebrow light">Residential &amp; Commercial Painting</p><h1>Arizona Painting and Coating<br />Done to a <em>Higher Standard</em></h1><p className="hero-lede">A Higher Standard of Painting</p><div className="hero-actions"><a className="button spectrum" href="#estimate" data-track="hero-estimate">Get a free estimate <span>↗</span></a><a className="text-link" href="tel:+16026156051" data-track="hero-call">(602) 615-6051</a></div></div>
        <div className="hero-mascot" aria-hidden="true"><img src="/mascot 1254 x 1254.png" alt="" /></div><div className="hero-stamp financing-stamp"><b style={{ color: "var(--gold)" }}>0% APR</b><span style={{ color: "white", letterSpacing: 0 }}>financing available for up to 24 months for qualified customers.</span></div><a className="scroll" href="#about" aria-label="Scroll to about section">↓</a>
      </section>
      ...
      <section className="paint-brands" aria-label="Professional paint brands"><p>Professional coatings from brands homeowners trust</p><div><strong>Sherwin-Williams</strong><span aria-hidden="true" /> <strong>Dunn-Edwards</strong></div></section>
      ...
      <section className="about section" id="about"><div className="about-image image-panel" role="img" aria-label="Beautifully painted modern home interior" /><div className="about-copy"><p className="eyebrow">About Color Rise</p><h2>Painting is the final detail.<br /><em>We treat it like the first.</em></h2><p>Great painting is equal parts preparation, precision, and respect for your space. Color Rise brings all three, from the first walkthrough to the final clean line.</p><p>We provide residential and commercial painting services throughout Phoenix, Tucson, Prescott, and surrounding Arizona communities. Our team handles interior painting, exterior painting, cabinet refinishing, and durable epoxy floor coatings.</p><div className="metrics"><div><strong>100%</strong><span>detail obsessed</span></div><div><strong>4</strong><span>signature services</span></div></div><a className="button navy" href="#estimate">Get a free estimate <span>↗</span></a></div></section>
      <section className="projects section" id="services"><div className="section-heading"><div><p className="eyebrow light">Painting services</p><h2>The right process<br />for <em>every surface.</em></h2></div><p>Explore the preparation, products, and process behind each Color Rise service.</p></div><div className="project-grid">{projects.map((p) => <a className={`project-card ${p.cls}`} href={p.href} key={p.title} data-track={`service-${p.href.split("/").pop()}`}><div className="project-meta"><span>{p.tag}</span><h3>{p.title} <small>↗</small></h3></div></a>)}</div><div className="commercial-service-link"><div><p className="eyebrow light">Commercial properties</p><h3>Painting planned around your property and operations.</h3></div><a className="button spectrum" href="/services/commercial-painting" data-track="service-commercial-painting">Explore commercial painting <span>↗</span></a></div></section>
      <section className="services section journal-section" id="journal"><div className="section-heading"><div><p className="eyebrow">Color journal</p><h2>Ideas with <em>character.</em></h2></div><p>Practical color guidance for homes and workplaces, written to help you make confident design decisions.</p></div><div className="service-grid">{journalArticles.map((s) => <article className={`service-card ${s.cls}`} key={s.title}><span className="service-number">{s.n}</span><div><h3>{s.title}</h3><p>{s.text}</p></div><a href={s.href} aria-label={`Read ${s.title}`}>↗</a></article>)}</div></section>
      <section className="process section estimate-process"><div className="process-intro"><p className="eyebrow">Your estimate</p><h2>Your project. Your options.<br /><em>Your choice.</em></h2><p>Getting a professional painting estimate shouldn’t be complicated. Color Rise makes it simple from the first request to the final proposal.</p><img src="/christina-rumpf-XWDMmk-yW7Q-unsplash.jpg" alt="Painter applying a careful finish" /></div><ol><li><span>01</span><div><h3>Request Your Free Estimate</h3><p>Tell us about your project online or give us a call. Choose a convenient appointment time and we’ll come to you.</p></div></li><li><span>02</span><div><h3>Meet With Your Color Rise Estimator</h3><p>We’ll inspect the project, take accurate measurements, discuss colors and finishes, and learn what matters most to you. No rushed estimates. No guesswork.</p></div></li><li><span>03</span><div><h3>Choose the Option That Fits You</h3><p>Receive a clear, professional proposal with <strong>Good, Better &amp; Best options</strong> when applicable. Compare scope, products, warranty and investment—then choose what works best for your home and budget.</p></div></li></ol><div className="process-estimate-cta"><a className="button navy" href="#estimate" data-track="process-estimate">Get my free estimate <span>↗</span></a><small>Financing available — including <strong style={{ color: "var(--gold)", fontWeight: 800 }}>0% APR</strong> for up to 24 months for qualified customers.</small></div></section>
