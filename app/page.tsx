  ...
  return (
    <main>
      ...
      <section className="hero" id="home">
        ...
        <div className="hero-mascot" aria-hidden="true"><img src="/mascot 1254 x 1254.png" alt="" /></div><div className="hero-stamp financing-stamp"><b>24 Months</b><span>0% Financing</span><small>Available on approved credit. Terms apply.</small></div><a className="scroll" href="#about" aria-label="Scroll to about section">↓</a>
      </section>
