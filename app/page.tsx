...
export default function Home() {
  ...
  return <main>
    ...
    <section className="hero" id="home">
      ...
      <div className="hero-copy"><p className="eyebrow light">Residential &amp; Commercial Painting</p><h1>Arizona Painting and Coating<br />Done to a <em>Higher Standard</em></h1><p className="hero-lede">Clear scope. Serious preparation. Premium coatings. A professional process from estimate to final walkthrough.</p><div className="hero-actions"><a className="button spectrum" href="#estimate" data-track="hero-estimate">Get a free estimate <span>↗</span></a><a className="text-link" href="tel:+16026156051" data-track="hero-call">(602) 615-6051</a></div></div>
      <div className="hero-mascot" aria-hidden="true"><img src="/mascot 1254 x 1254.png" alt="" /></div>
      <div className="hero-stamp financing-stamp"><b style={{ color: "var(--gold)" }}>0% APR</b><span style={{ color: "white", letterSpacing: 0 }}>financing available for up to 24 months for qualified customers.</span></div>
    </section>
    ...
    <section className="services section"><div className="section-heading"><div><p className="eyebrow">Clear proposal options</p><h2>One project.<br/><em>Three clear options.</em></h2></div><p>No vague estimates. When the project supports multiple approaches, compare what changes and choose deliberately.</p></div><div className="service-grid">
      <article className="service-card interior"><span className="service-number">GOOD</span><div><h3>Professional</h3><p>A sound repaint solution with the documented preparation and professional coating system required for the selected scope.</p></div></article>
      <article className="service-card exterior"><span className="service-number">BETTER</span><div><h3>Enhanced</h3><p>Upgraded preparation, coating, or protection options where they materially improve the project. Often the best value for long-term ownership.</p></div></article>
      <article className="service-card cabinets"><span className="service-number">BEST</span><div><h3>Premium</h3><p>Our highest applicable specification for homeowners prioritizing maximum preparation, premium coating choices, and protection.</p></div></article>
      <article className="service-card epoxy"><span className="service-number">COMPARE</span><div><h3>Scope. Product. Warranty. Investment.</h3><p>We show what changes between options so you are comparing actual value—not just three prices.</p></div></article>
    </div></section>
    ...
    <section className="process section estimate-process"><div className="process-intro"><p className="eyebrow">Your estimate</p><h2>Your project. Your options.<br/><em>Your choice.</em></h2><p>Getting a professional painting estimate should not be complicated. Color Rise makes it simple from the first request to the final proposal.</p></div><ol><li><span>01</span><div><h3>Request your free estimate</h3><p>Tell us about your project online or give us a call and choose a convenient appointment time.</p></div></li><li><span>02</span><div><h3>Meet your Color Rise estimator</h3><p>We inspect the project, take measurements, discuss goals and finishes, and identify preparation requirements.</p></div></li><li><span>03</span><div><h3>Choose the option that fits</h3><p>Receive a clear professional proposal with Good, Better &amp; Best options when applicable. Compare scope, products, warranty, and investment.</p></div></li></ol></section>
    ...
    <section className="estimate section" id